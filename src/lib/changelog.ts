...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      "Saving a pocket as a blueprint confirms in one dialog: name, icon, what it needs and makes. The pocket card's save button, the share flow and overwriting all land there.",
