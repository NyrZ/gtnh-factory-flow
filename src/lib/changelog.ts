...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    notes: [
      ...
      "The Read the board tour has been rebuilt. It reads out a real diagnosis: a machine that is fed fine and still cannot keep up, then one further down where three inputs all look short and only one of them is actually the problem. Then a step for each of the four drawer shapes and what each one asks for.",
      "It finishes by breaking the factory in front of you. It deletes the drawer taking the finished titanium, and the whole six machine line drops to nothing, because everything a machine makes has to be going somewhere. The drawer comes back when you leave.",
