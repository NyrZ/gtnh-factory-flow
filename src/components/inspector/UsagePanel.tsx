...
function UsageCellButton({
  ...
  return (
    ...
    <button
      ...
      className="relative aspect-square overflow-hidden rounded border border-transparent hover:border-cyan-500/60 hover:bg-cyan-500/10"
    >
      ...
      <span
        className={[
          ...
          "[text-shadow:0_0_3px_rgba(0,0,0,0.9),0_1px_2px_rgba(0,0,0,0.95)]",
