    ...
    <div ref={rootRef} className={["relative min-w-0", className].join(" ")}>
      ...
      {isOpen ? (
        <div
          ...
          className="nodrag nowheel absolute left-0 top-full z-[140] mt-0.5 max-h-[280px] w-full min-w-[150px] overflow-y-auto border-2 border-[var(--mc-15)] bg-[var(--mc-78)] p-0.5 shadow-[inset_1px_1px_0_var(--mc-100),inset_-1px_-1px_0_var(--mc-33),3px_3px_0_rgba(0,0,0,0.35)]"
          onPointerDown={(event) => event.stopPropagation()}
