          ...
          {options.map((option) => {
            ...
            return (
              <button
                ...
                className={[
                  "flex w-full items-center gap-1.5 border border-transparent px-1.5 py-1 text-left text-[12px] font-bold leading-4 text-[var(--mc-ink)] hover:border-[var(--mc-47)] hover:bg-[var(--mc-100)]",
